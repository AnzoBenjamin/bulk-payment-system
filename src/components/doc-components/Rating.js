...
const placeholderCode = `function PlaceholderExample() {
  return (
    <Rating
      ...
      emptySymbol={<FontAwesomeIcon icon={['far','star']} className="text-warning fs-7 me-1" />}
      placeholderSymbol={<FontAwesomeIcon icon="star" className="text-danger fs-7 me-1" />}
      fullSymbol={<FontAwesomeIcon icon="star" className="text-warning fs-7 me-1" />}
    />
  );
}`;
