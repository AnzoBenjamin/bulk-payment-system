...
const Courses = () => {
  ...
  useEffect(() => {
    ...
    const currentNavbarState = coursesNavbarVerticalCollapsed.current; // Copy the ref value

    return () => {
      setConfig("isNavbarVerticalCollapsed", currentNavbarState); // Use the copied value
    };
  }, [setConfig]);
