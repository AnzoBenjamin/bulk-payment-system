export const rootPaths = {
  ...
  appsRoot: "dashboard/app",
  emailRoot: "dashboard/email",
  eventsRoot: "dashboard/events",
  socialRoot: "dashboard/social",
  eCommerceRoot: "dashboard/e-commerce",
  productRoot: "dashboard/product",
  eLearningRoot: "dashboard/e-learning",
  supportDeskRoot: "dashboard/support-desk",
  componentsRoot: "dashboard/components",
  pagesRoot: "dashboard/pages",
  authRoot: "authentication",
  authSimpleRoot: "simple",
  authCardRoot: "card",
  authSplitRoot: "split",
  userRoot: "dashboard/user",
  pricingRoot: "dashboard/pricing",
  faqRoot: "dashboard/faq",
  errorsRoot: "errors",
  miscRoot: "dashboard/miscellaneous",
  formsRoot: "dashboard/forms",
  basicFormsRoot: "basic",
  advanceFormsRoot: "advance",
  tableRoot: "dashboard/tables",
  chartsRoot: "dashboard/charts",
  echartsRoot: "echarts",
  iconsRoot: "dashboard/icons",
  mapsRoot: "dashboard/maps",
  carouselRoot: "carousel",
  navsAndTabsRoot: "navs-and-tabs",
  picturesRoot: "pictures",
  videosRoot: "videos",
  utilitiesRoot: "dashboard/utilities",
  docRoot: "dashboard/documentation",
};
